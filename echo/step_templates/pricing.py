...
def save_client_data_to_db(client_name, seller_name):
    ...
    save_client_call_data(
        client_name, BUYER, PRICING, inputs, 
        get_client_data_to_save(client_name, BUYER)
    )
    save_client_call_data(
        client_name, SELLER, PRICING, inputs, 
        get_client_data_to_save(client_name, SELLER)
    )
    embed_client_call_data(
        client_name, BUYER, PRICING, inputs, 
        get_client_data_to_embed(client_name, BUYER)
    )